<template>
    <div class="card" :data-category="this.$props.item.category">
        <div class="card-star">
          <svg width="14" 
          height="14" 
          viewBox="0 0 14 14" 
...
export default {
      ...
      methods:{
        addItem(){
          this.$store.commit('basketCountPlus')
          this.$store.commit('pushItem', this.$props.item)
        }
      },
...
.card-basket svg path{
    fill:#959DAD;
}
.card-basket svg:hover path{
    fill: #1F1F1F;
}
